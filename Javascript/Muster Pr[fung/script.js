...
console.log('*********************9. Manipuliere das Element mit der ID „mobile-menu“')
console.log('*********************A: Füge die Klasse „active“ hinzu')
...
form.addEventListener("submit", function(event) {
  ...
  if (!send) {
    ...
    let message = document.getElementById('already-send-message');
